...
//once_flag
#include <mutex>
#define ONE_MODEL_VETRTEX (24)
#define ONE_MODEL_FACE (12)
#define ONE_MODEL_FILE ("model/one.ply")
//camera
#include "manipulator.h"
//player
#include "Player.h"
void CNumberOne::Init() {

	//継承したクラスごとに一度だけ読む
	static std::once_flag flag;
	std::call_once(flag, [this]() {
		m_Model->Init(ONE_MODEL_FILE, ONE_MODEL_VETRTEX, ONE_MODEL_FACE);
		});

}
void CNumberOne::Update()
{
