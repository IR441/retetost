...
#include <mutex>
//model data
#define ZERO_MODEL_VETRTEX (576)
#define ZERO_MODEL_FACE (384)
#define ZERO_MODEL_FILE ("model/zero.ply")
//camera
#include "manipulator.h"
//player
#include "Player.h"
void  CNumberZero::Init() {

	//継承したクラスごとに一度だけ読む
	static std::once_flag flag;
	std::call_once(flag, [this]() {
		m_Model->Init(ZERO_MODEL_FILE, ZERO_MODEL_VETRTEX, ZERO_MODEL_FACE);
		});

}
void  CNumberZero::Update()
{
