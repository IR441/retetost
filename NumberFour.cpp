...
//once_flag
#include <mutex>
#define FOUR_MODEL_VETRTEX (98)
#define FOUR_MODEL_FACE (60)
#define FOUR_MODEL_FILE ("model/four.ply")
//camera
#include "manipulator.h"
//player
#include "Player.h"
void CNumberFour::Init() {

	//継承したクラスごとに一度だけ読む
	static std::once_flag flag;
	std::call_once(flag, [this]() {
		m_Model->Init(FOUR_MODEL_FILE, FOUR_MODEL_VETRTEX, FOUR_MODEL_FACE);
		});

}
void CNumberFour::Update()
{
