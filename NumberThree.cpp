...
//once_flag
#include <mutex>
#define THREE_MODEL_VETRTEX (911)
#define THREE_MODEL_FACE (584)
#define THREE_MODEL_FILE ("model/three.ply")
//camera
#include "manipulator.h"
//player
#include "Player.h"
void CNumberThree::Init() {

	//継承したクラスごとに一度だけ読む
	static std::once_flag flag;
	std::call_once(flag, [this]() {
		m_Model->Init(THREE_MODEL_FILE, THREE_MODEL_VETRTEX, THREE_MODEL_FACE);
		});

}
void CNumberThree::Update()
{
