...
#include <mutex>
//model data
#define SEVEN_MODEL_VETRTEX (36)
#define SEVEN_MODEL_FACE (20)
#define SEVEN_MODEL_FILE ("model/seven.ply")
//camera
#include "manipulator.h"
//player
#include "Player.h"
void  CNumberSeven::Init() {

	//継承したクラスごとに一度だけ読む
	static std::once_flag flag;
	std::call_once(flag, [this]() {
		m_Model->Init(SEVEN_MODEL_FILE, SEVEN_MODEL_VETRTEX, SEVEN_MODEL_FACE);
		});

}
void  CNumberSeven::Update()
{
