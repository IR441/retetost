...
#include <mutex>
//model data
#define EIGHT_MODEL_VETRTEX (1158)
#define EIGHT_MODEL_FACE (772)
#define EIGHT_MODEL_FILE ("model/eight.ply")
//camera
#include "manipulator.h"
//player
#include "Player.h"
void  CNumberEight::Init() {

	//継承したクラスごとに一度だけ読む
	static std::once_flag flag;
	std::call_once(flag, [this]() {
		m_Model->Init(EIGHT_MODEL_FILE, EIGHT_MODEL_VETRTEX, EIGHT_MODEL_FACE);
		});

}
void  CNumberEight::Update()
{
